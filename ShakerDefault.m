classdef ShakerDefault < models.muscle.AMuscleConfig
    ...
    methods
        ...
        function prepareSimulation(this, ~, ~)
            ...
            % set frequency (F) and amplitude (Amp)
            this.VelocityBCTimeFun = general.functions.Sinus(...
                'Frequency',this.F,...
                'Amplitude',this.Amp);
        end
    ...
    methods(Access=protected)
        ...
        function displ_dir = setPositionDirichletBC(this, displ_dir)
            ...
            displ_dir([1 3],geo.Elements(length(geo.Elements)-3:length(geo.Elements),...
        ...
        function [velo_dir, velo_dir_val] = setVelocityDirichletBC(this, velo_dir, velo_dir_val)
            ...
            velo_dir(2,geo.Elements(length(geo.Elements)-3:length(geo.Elements),...
                geo.MasterFaces(4,:))) = true;
